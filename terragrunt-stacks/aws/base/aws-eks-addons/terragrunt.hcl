...
terraform {
  source = "${get_parent_terragrunt_dir()}/../../..//modules/aws-eks-addons"
...
inputs = {
  eks_cluster_name = dependency.aws-base.outputs.eks.cluster_id
  aws_account_id=local.common_vars.account_id
